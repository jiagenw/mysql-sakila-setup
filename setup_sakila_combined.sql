-- Combined Sakila setup for fun_sql database
USE fun_sql;
...
-- Add the missing foreign key constraint for staff.store_id
...
-- Now let's add some basic sample data
...
('123 Main St', 'Downtown', 1, '10001', '555-0101'),
('456 Oak Ave', 'Westside', 2, '90210', '555-0102'),
('789 Pine Rd', 'Uptown', 3, 'M5V 3A8', '555-0103'),
('321 Elm St', 'Central', 4, 'SW1A 1AA', '555-0104'),
('654 Maple Dr', 'Mitte', 5, '10115', '555-0105');
...
-- Create a basic store and staff (fixing circular dependency)
...
('Manager', 'One', 1, 'manager1@store.com', 1, 'manager1', 'password123');
...
(1, 'Customer', 'One', 'customer1@email.com', 2, NOW()),
(1, 'Customer', 'Two', 'customer2@email.com', 3, NOW()),
(1, 'Customer', 'Three', 'customer3@email.com', 4, NOW());
...
('The Adventure Begins', 'An exciting adventure film', 2020, 1, 3, 4.99, 120, 19.99, 'PG'),
('Comedy Central', 'A hilarious comedy', 2019, 1, 3, 3.99, 95, 15.99, 'G'),
('Drama Queen', 'A dramatic masterpiece', 2021, 1, 5, 5.99, 140, 24.99, 'PG-13');

-- Add film categories
INSERT INTO film_category (film_id, category_id) VALUES 
(1, 1), -- Adventure in Action
(2, 2), -- Comedy in Comedy
(3, 3); -- Drama in Drama

-- Add film actors
INSERT INTO film_actor (actor_id, film_id) VALUES 
(1, 1), -- John Doe in Adventure
(2, 1), -- Jane Smith in Adventure
(3, 2), -- Bob Johnson in Comedy
(4, 3); -- Alice Brown in Drama

-- Add inventory
INSERT INTO inventory (film_id, store_id) VALUES 
(1, 1), (1, 1), (1, 1), -- 3 copies of Adventure
(2, 1), (2, 1), -- 2 copies of Comedy
(3, 1); -- 1 copy of Drama

-- Add some rentals
INSERT INTO rental (rental_date, inventory_id, customer_id, staff_id) VALUES 
(NOW() - INTERVAL 5 DAY, 1, 1, 1),
(NOW() - INTERVAL 3 DAY, 2, 2, 1),
(NOW() - INTERVAL 1 DAY, 3, 3, 1);

-- Add some payments
INSERT INTO payment (customer_id, staff_id, rental_id, amount, payment_date) VALUES 
(1, 1, 1, 4.99, NOW() - INTERVAL 5 DAY),
(2, 1, 2, 4.99, NOW() - INTERVAL 3 DAY),
(3, 1, 3, 4.99, NOW() - INTERVAL 1 DAY);
